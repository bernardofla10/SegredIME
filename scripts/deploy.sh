...
echo "║   Portas: 8013 (front) | 8014 (back) | 8015 ║"
echo "╚══════════════════════════════════════════════╝"
echo ""
...
echo "║   🌐 URLs de Acesso                         ║"
echo "╠══════════════════════════════════════════════╣"
echo "║   Frontend: http://192.168.91.176:8013      ║"
echo "║   Backend:  http://192.168.91.176:8014/api/  ║"
echo "║   Admin:    http://192.168.91.176:8014/admin/ ║"
echo "╚══════════════════════════════════════════════╝"
echo ""
